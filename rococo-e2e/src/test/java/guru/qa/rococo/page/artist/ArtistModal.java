...
public class ArtistModal extends BasePage<ArtistModal> {
    ...
    @Step("Check that artist modal is loaded")
    @Override
    public ArtistModal checkThatPageLoaded() {
        modalPage.shouldHave(text("Редактировать художника"));
        return this;
    }
}
